...
unsigned long shadow_sequence_number(int placeNumber)
{
	...
	if (placeNumber == 1) //set first place equal to 9
	{
		returnValue = 9;
	}
	else if (placeNumber == 2) //set second place equal to 0
	{
		returnValue = 0;
	}
	else //calculate rest of sequence using algorithm provided in instructions
	{
